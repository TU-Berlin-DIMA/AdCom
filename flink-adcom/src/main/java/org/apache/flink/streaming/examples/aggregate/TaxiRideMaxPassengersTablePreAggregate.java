 ...
 * </pre>
 */
public class TaxiRideMaxPassengersTablePreAggregate {
	public static void main(String[] args) throws Exception {
		...
		Table resultTableStream = ridesTableStream
			.groupBy($("driverId"))
			.select($("driverId"), $("passengerCnt").max().as("passengerCnt"));
		...
		env.execute(TaxiRideMaxPassengersTablePreAggregate.class.getSimpleName());
		// @formatter:on
	}
}
